...
var Node = {
  ...
  //funcion de inicializacion del nodo
  ...
  //funcion para separar elementos en un nodo
  splitNode: function(){
    var tmp = Node;
...
/**
Basado en la version de Stoyan Pedev http://blog.conquex.com/?p=84
**/
